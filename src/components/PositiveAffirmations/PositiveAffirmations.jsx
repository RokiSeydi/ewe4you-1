...
class PositiveAffirmations extends Component {
  ...
  showInstructions = () => {
    return this.state.affirmations.length > 2 ? (
      <p className={styles.showInstructionsStyle}>
        {" "}
        Repeat these 3 times to yourself in a mirror You will help create a more positive narrative about yourself if
        you do this regularly. It will also help to create a more flexible and healthy view of yourself.{" "}
      </p>
    ) : null;
  };
